...
static struct body solar_bodies[] = {
    /* sun */
    {.x = {0., 0., 0.}, .v = {0., 0., 0.}, .mass = SOLAR_MASS},
    /* jupiter */
    {.x = {4.84143144246472090e+00, -1.16032004402742839e+00,
    ...
    /* saturn */
    {.x = {8.34336671824457987e+00, 4.12479856412430479e+00,
    ...
    /* uranus */
    {.x = {1.28943695621391310e+01, -1.51111514016986312e+01,
    ...
    /* neptune */
    {.x = {1.53796971148509165e+01, -2.59193146099879641e+01,
